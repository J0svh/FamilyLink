...
export default function MapPage() {
  ...
  return (
    <div className="h-screen w-screen relative">
      ...
      <div className="absolute bottom-[calc(env(safe-area-inset-bottom,0px)+2rem)] left-0 right-0 sm:bottom-6 sm:left-4 sm:right-4">
        <div className="flex items-center gap-2 sm:gap-3 overflow-x-auto scrollbar-hide px-3 pb-1 sm:px-0 sm:justify-center touch-pan-x">
          {/* Status button */}
          <motion.button
            whileTap={{ scale: 0.9 }}
